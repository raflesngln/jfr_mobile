...
const DATA_CARD = [
  {id: 1, short: 'CDO', title: 'Cargo Delivery Order', icon: 'truck-plane'},
  {
    id: 2,
    short: 'DOP',
    title: 'Delivery Order Preparation',
    icon: 'cart-flatbed-suitcase',
  },
  {id: 3, short: 'POD', title: 'Proof Of Delivery', icon: 'cart-flatbed'},
  {id: 4, short: '', title: 'History', icon: 'clock-rotate-left'},
  {id: 5, short: '', title: 'Tracking', icon: 'map-location-dot'},
];
const DomesticScreen: React.FC = (props: any) => {
